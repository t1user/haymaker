...
import numpy as np
import pandas as pd
from haymaker.research.backtester.pipeline import perf as perf_new, no_stop, _PerfCalculator
...
if __name__ == "__main__":
    ...
    calc = _PerfCalculator(_TransactionFrame(tx), slippage=1.5, use_numba=True, skip_last_open=False, raise_exceptions=False)
