...
7. **Review Runtime Object Boundaries**
   - Review whether manager, download job, download container,
     ...
     responsibilities.
   - First-class `TaskPlanner` now owns pure range planning, max-period
     clamping, and gap-fill extraction from supplied schedule/session inputs.
