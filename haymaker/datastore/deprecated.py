...
# ==================================================================
# DEPRECATED
# Some old research files still use it,
# but needs to be removed/redone
# ==================================================================
...
class Store:
    ...
    def keys(self):
        with self.store() as store:
            keys = store.keys()
        return keys
        """ TODO: implement pickle store df = pd.read_pickle(
        'notebooks/data/minute_NQ_cont_non_active_included.pickle'
