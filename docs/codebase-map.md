...
- `haymaker/research/indicators/`: indicator package with mean/weighted-mean
  helpers, technical indicators, breakout/channel indicators, and generic
  transformers for converting indicators or prices into discrete events,
  filters, or desired exposure. `haymaker/indicators.py` remains a
